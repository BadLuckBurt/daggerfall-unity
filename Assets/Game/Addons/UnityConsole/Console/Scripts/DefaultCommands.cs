...
namespace Wenzil.Console
{
    public class DefaultCommands : MonoBehaviour
    {
        ...
        private static class AddInventoryItem
        {
            ...
            public static readonly string usage = "add (book|weapon|armor|cloth|ingr|relig|soul|gold|magic|drug|map|torch|tent) [n]";
                ...
                while (n >= 1)
                {
                    ...
                    switch (args[0])
                    {
                        ...
                        case "soultrap":
                            ...
                            break;
                        case "tent":
                            newItem = ItemBuilder.CreateItem(ItemGroups.UselessItems2, 515);
                            break;
                        default:
